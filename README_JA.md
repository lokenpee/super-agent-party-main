...
<div align="center">
  <a href="https://www.agentparty.top/"><img src="https://img.shields.io/badge/公式サイト-AgentParty-blueviolet?style=for-the-badge"/></a>
  <a href="https://www.agentparty.top/blog.html"><img src="https://img.shields.io/badge/公式ブログ-Blog-orange?style=for-the-badge&logo=rss&logoColor=white"/></a>
  <a href="https://space.bilibili.com/26978344"><img src="https://img.shields.io/badge/Bilibili-チュートリアル-red?style=for-the-badge&logo=bilibili"/></a>
  <a href="https://www.youtube.com/@LLM-party"><img src="https://img.shields.io/badge/YouTube-チャンネル登録-FF0000?style=for-the-badge&logo=youtube"/></a>
  <a href="https://gcnij7egmcww.feishu.cn/wiki/DPRKwdetCiYBhPkPpXWcugujnRc"><img src="https://img.shields.io/badge/中国語ガイド-Feishuドキュメント-00CDCD?style=for-the-badge&logo=docsdotrs"/></a>
  <a href="https://temporal-lantern-7e8.notion.site/super-agent-party-211b2b2cb6f180c899d1c27a98c4965d"><img src="https://img.shields.io/badge/英語ガイド-Notion-000000?style=for-the-badge&logo=notion"/></a>
  <a href="#クイックスタート"><img src="https://img.shields.io/badge/クイックスタート-ダウンロード-0052CC?style=for-the-badge&logo=github"/></a>
</div>
...
#### 拡張機能システム：拡張機能のインストールと新規作成に対応。下の画像はギャルゲー拡張機能です。すべての拡張機能は独立ウィンドウまたはサイドバーで開くことができます。
...
| ストレージスペース | すべてのファイルとデータはユーザーのローカルデータフォルダに保存されます。NASでデプロイすると、ローカルネットワーク内の個人用画像またはファイルホストとしても使用可能。 |
...
5. このプロジェクトに表示されるサードパーティの商標、ロゴ、またはブランド名（OpenAI、Microsoft、Google、Bing、Bilibiliなどを含むがこれらに限定されない）は、それぞれの所有者の資産です。これらの識別子は、使用されているモデルまたはサービスをユーザーが認識しやすくするためにのみ表示されており、これらの権利保有者による公式な提携、スポンサーシップ、または承認を意味するものではありません。関連する商標、インターフェース、またはブランドの所有者が、このプロジェクトの使用が不適切であると考える場合、またはブランド識別子/インターフェースがこのソフトウェアを通じて表示またはアクセスされることを望まない場合は、GitHub Issuesまたはhst97@qq.comを通じてリポジトリ管理者にご連絡ください。通知を受け取り次第、速やかに（通常48時間以内に）要求に応じてコンテンツを削除、修正いたします。

6. このプロジェクトは独自に開発されたオープンソースツールです。ユーザーがこのソフトウェアを使用してサードパーティのAPIサービスにアクセスする場合、関連するサービスプロバイダーの利用規約を遵守する責任はユーザーにあります。

7. このソフトウェアがサードパーティの大規模モデルを通じて生成したコンテンツの正確性、完全性、およびコンプライアンスについては、モデルプロバイダーとユーザーの行為が責任を負います。本ソフトウェアの作者は、そのようなコンテンツに対して法的責任を負いません。
